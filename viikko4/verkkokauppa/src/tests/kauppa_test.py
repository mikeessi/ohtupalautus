...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostetaan_kaksi_tavaraa_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
    ...
    def test_ostetaan_kaksi_samaa_tavaraa_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_ostetaan_kaksi_tuotetta_toinen_loppu_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_kauppa_pyytaa_viitenumeron_jokaiselle_maksutapahtumalle(self):
    ...
    def test_tuotteen_poistaminen_ostoskorista_palauttaa_sen_varastoon(self):
        ...
        self.kauppa.tilimaksu("pekka", "12345")
        self.pankki_mock.tilisiirto.assert_called_with(ANY,ANY,ANY,ANY,0)
        self.varasto_mock.palauta_varastoon.assert_called_with(ANY)
